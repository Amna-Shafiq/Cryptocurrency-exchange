...
def exchange_rate(request):
    ...
    bitfinex_price = service.find_lowest_price_bitfinex(bitfinex_data_asks, amount)

    best_price = min(filter(None, [binance_price, coinbase_price, bitfinex_price]))
